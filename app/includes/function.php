<?php
	...
	define('projeto', 'orpit/pagpar/app/');
	define('servidor', 'http://minhaarea.itismyweb.com.br/');
	define('images', servidor.projeto.'assets/images/');

	function url($data){
		echo servidor.projeto.$data.'.php';
	}
?>
